...
def parse_args(args):
    ...
    parser.add_argument("--num_users", help="description for number of users to generate")
    parser.add_argument("--num_emails", help="number of emails each user will generate")
...
#     parser.add_argument("--num_users", help="description for number of users to generate")
#     parser.add_argument("--num_emails", help="number of emails each user will generate")
#     parser.add_argument("--concurrency", help="number for concurrency")
